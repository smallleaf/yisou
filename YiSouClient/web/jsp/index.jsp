	...
	$(function(){
		$(function(){
			...
			$("li:not(.active)").click(function(){
				...
				if(searchType=='jar'){
					$("#searchForm").attr("action","http://localhost:8083/jar.do");
				}else{
			...
			<div class="row search-lable">
				<div class="col-md-6 col-md-offset-1" style="margin-top:7px;">
						<ul class="nav nav-pills">
									...
									<a>网盘 </a></li>
									<li role="presentation" id="file" class="active"><span class="hide">file</span>
									<a>文档 </a></li>
									<li role="presentation" id="jar" class=""><span class="hide">jar</span>
									<a>Jar</a></li>
									<li role="presentation" id="other" class=""><span class="hide">other</span>
									<a>其他 </a></li>
							</ul>
				</div>
			</div>
